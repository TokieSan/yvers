...
Yvers is a new extensible TUI system monitor and a Linux Process Manager. Based on ytop with numerous improvements and the addtion to the capability of dynamically adding widgets created by the community.
